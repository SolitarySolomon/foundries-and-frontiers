...
- **Every threshold is config.** No magic numbers compiled in — the balance pass depends
...
- [ ] **D4 · Site selection** — **RISK.** Interior cells for buildings, peripheral for plots,
      and off-grid for what must follow terrain — quarry against rock, well at the water table.
...
- [ ] **H3 · Orphans** — when a village dies, the survivors don't simply vanish. They set
      ...
      population it didn't grow, and the arrivals carry the memory of what happened —
