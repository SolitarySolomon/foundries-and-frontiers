...
public class VillagerPathfind
{
	...
	public List<VillagerPathNode> FindPath(BlockPos start, BlockPos end)
	{
	...
	public List<Vec3d> FindPathAsWaypoints(BlockPos start, BlockPos end)
	{
		List<VillagerPathNode> list = FindPath(start, end);
		if (list != null)
		{
